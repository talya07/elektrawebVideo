      ...
      for (let index = 0; index < data[i].videos.length; index++) {
        ...
        videoLinks += `
          ...
          data[i].videos[index].videoName
                    ...
                    <span onclick="showDesc('sec${i}part${index}');" class="${showDesc}"><span id="chevron_${"sec"+i +"part"+ index
...
function showVideo(e) {
  ...
  var videoHtml =
    ...
    e.dataset.video +'?autoplay=1"></iframe>';
